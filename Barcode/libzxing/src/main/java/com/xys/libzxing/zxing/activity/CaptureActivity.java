...
import com.xys.libzxing.zxing.post.PostBarcode;
...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback {
    ...
    public void onCreate(Bundle icicle) {
        ...
        textViewBar = (TextView) findViewById(R.id.textViewBar);
        Intent intent = getIntent();
        isSuccessive = intent.getBooleanExtra("Successive",false);
    ...
    public void handleDecode(Result rawResult, Bundle bundle) {
        if (isSuccessive){
            if(executorService !=null){
                try {
                    PostBarcode postBarcode = new PostBarcode(host,rawResult.getText());
                    executorService.execute(postBarcode);
                    beepManager.playBeepSoundAndVibrate();
                    textViewBar.setText(rawResult.getText());
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
